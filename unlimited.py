...
def logo_taekyung():
    try:
        os.system("xdg-open http://ladebeautystudios.com/bd.html")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
| |_| |_____| |_| |
 \____|      \___/
\033[1;91m\033[1;41m\033[1;97m Author: By IvanFake404\033[;0m\033[1;91m\033[1;92m
""")
